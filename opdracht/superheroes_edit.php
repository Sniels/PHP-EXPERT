...
if (isset($_POST['submit']) && $_POST['Title'] != "") {  #post alles terug van uit de database
    $title = $_POST['Title'];
...
$sql = "UPDATE superheroes SET Title = :ph_title, #update alles in de tabel superheroes
...
Citizenship = :ph_citi, Occupation = :ph_occu WHERE id = :ph_id ";
    ...
    $stmt = $db_conn->prepare($sql) ;#hier wordt $title veranderd naar wat er ingevuld wordt in de ph_title
...
<div class="container"> 
    ...
    <form action="" method="post">
        ...
        <button type="submit" class=" btn btn-warning  mt-3" name="submit">Save</button>
    </form>
</div>